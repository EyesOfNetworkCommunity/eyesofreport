...
time_day_record=$(MYSQL_PWD="SaintThomas,2014" mysql -ueyesofreport -h $HOST -e "SELECT chg_id FROM eor_ods.chargements where chg_etl ='ETL_ODS_LOGS_EON' and chg_date='$today' and chg_source='$SOURCE' limit 1;")
