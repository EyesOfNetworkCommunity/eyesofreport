...
time_day_record=$(MYSQL_PWD="SaintThomas,2014" mysql -ueyesofreport -h $HOST -e "SELECT time FROM thruk.${BACKEND}_log where time between $extractbeg and $extractend limit 1;")
