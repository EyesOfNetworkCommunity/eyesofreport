...
--
-- Dumping data for table `contract_context_application_ttr`
--

LOCK TABLES `contract_context_application_ttr` WRITE;
/*!40000 ALTER TABLE `contract_context_application_ttr` DISABLE KEYS */;
/*!40000 ALTER TABLE `contract_context_application_ttr` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-10-27 12:17:59
