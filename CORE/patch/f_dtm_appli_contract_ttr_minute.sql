...
--
-- Dumping data for table `f_dtm_appli_contract_ttr_minute`
--

LOCK TABLES `f_dtm_appli_contract_ttr_minute` WRITE;
/*!40000 ALTER TABLE `f_dtm_appli_contract_ttr_minute` DISABLE KEYS */;
/*!40000 ALTER TABLE `f_dtm_appli_contract_ttr_minute` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2016-10-27 11:38:49
