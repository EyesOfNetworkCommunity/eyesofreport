...
container_nagios_log_today=$(date "+nagios-%m-%d-%Y-00.log")
container_nagios_log_yesterday=$(date -d "-1 days" "+nagios-%m-%d-%Y-00.log")
rm -f /srv/eyesofnetwork/nagios/var/log/archives/${container_nagios_log_today}
rm -f /srv/eyesofnetwork/nagios/var/log/archives/${container_nagios_log_yesterday}
