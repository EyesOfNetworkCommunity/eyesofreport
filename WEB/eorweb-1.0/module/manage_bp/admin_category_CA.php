...
<html lang="en">
  ...
  <body onload="InitLoad()">
    <div class="container">        
          <h2 class="form-signin-heading">Category Customer Access</h2>
                              ...
                              echo "
							      ...
							      AND (bp_link like '%_ca' OR bp_link like '%_CA' )
                                                              AND bp_link NOT IN 
                                                                (SELECT bp_name 
                                                                  FROM bp_category 
                                                                  WHERE category = 'Customer Access' 
                  ...
                  <div class="col-xs-6">
                    ...
                    <ul class="target connected">
                        ...
                        <?php
                            $sql = "
                                SELECT *
                                FROM bp_category WHERE category = 'Customer Access' ORDER BY bp_source
                            ";
