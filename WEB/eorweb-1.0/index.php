...
<div class="zone_footer">
	<a href="http://www.eyesofnetwork.com" target="_blank">EyesOfReport a project of EyesOfNetwork Team</a> <?php echo $xmlmenus->getElementsByTagName("footer")->item(0)->nodeValue?>
</div>
