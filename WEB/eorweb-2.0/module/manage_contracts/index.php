	...
	<div id="global_container" class="row" style="display: none">
		<div class="panel panel-default">
			<div class="panel-heading">
				<div class="row">
		        	<span class="col-md-6"><?php echo getLabel("label.manage_contract.record_number"); ?></span>
		        	<span class="col-md-6"><?php echo getLabel("label.manage_contract.record_entries"); ?></span>
	        	</div>
	        </div>
