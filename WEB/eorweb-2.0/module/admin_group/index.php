	...
	if( isset($_POST['action']) && $_POST['action'] == "import" ){
		if(!empty($_POST['import_list'])){
			...
			foreach ($_POST['import_list'] as $key => $value) {
				...
				$test = insert_user(stripAccents($usrname), $userdesc, $usergroup, $user_password1, $user_password2, $usrtype, $usrlocation,$usrlimitation, false, $in_nagvis, $in_cacti, $nagvis_role_id);
