...
if(isset($_GET["name"])) {
	...
	$application=retrieve_form_data("application",null);
		...
		<form class="form-horizontal" action='./add_process.php' method='POST' name='form_bp'>
			...
			<div class="row">
				<div class="form-group">
					...
					<div class="col-md-7">
						...
						echo "<select class=\"form-control\" name=\"source_name\"".$select_disabled." onchange=\"javascript:set_display_number()\">";
			...
			<div class="row">
				<div class="form-group">
					...
					<div class="col-md-7">
						<input class="form-control" name="process_name" value="" onChange="javascript:checkName(this)"/>
					</div>
				</div>
			</div>
			...
			<div class="row">
				<div class="form-group">
					...
					<div class="col-md-7">
						<select class="form-control" size="1" name="process_prio" onChange="javascript:isDisp(this);"></select>
					</div>
				</div>
			</div>
