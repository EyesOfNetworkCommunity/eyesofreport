...
<div id="page-wrapper">
		...
		<div class="row">
			<div class="col-md-7">
				<div class="panel panel-default">
					<div class="panel-heading"><?php echo getLabel("Define BP"); ?></div>
			...
			<div class="col-md-7">
				<div class="panel panel-default">
					...
					<div class="panel-body">
						...
						<div id="sum" class="row form-group"></div>
						<div class="row">
	...
	<div class="row">
		<div class="col-md-12">
			<input class="btn btn-primary" type="button" value="menu bp" onclick="location.href='./index.php'">
		</div>
	</div>
</div>
