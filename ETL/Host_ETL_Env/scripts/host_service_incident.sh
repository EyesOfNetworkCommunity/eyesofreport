...
zip ./ETL_DTM_COMPUTE_HS_INCIDENT_JAR.jar ./HostServiceTimeToResolve.properties

export LANG=en_US
JAVA_Validator="/srv/eyesofreport/etl/validator/ETL_DTM_COMPUTE_HS_INCIDENT_JAR.jar"

usage() {
echo "Usage :host_service_incident.sh epochbegin epochend"
exit
}

LOGDIR="/var/log/eyesofreport/host_service_incident"
